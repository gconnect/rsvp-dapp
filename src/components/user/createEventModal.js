...
export default function CreateEventModal(props) {
  ...
  const [metahash, setMetaHas] = useState("")
  ...
  const  microalgosToAlgos = (microalgos ) => {
    ...
    const createToken = async ()=>{
      ...
      const token = await stdlib.launchToken(acc, tokenName, tokenSymbol, {supply: microalgosToAlgos(totalTickets), metadataHash: `ipfs://${metahash}`});
